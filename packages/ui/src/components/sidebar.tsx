...
import { ScrollArea } from "@struxa/ui/components/scroll-area";
import { Separator } from "@struxa/ui/components/separator";
import {
  Sheet,
  SheetDescription,
  SheetHeader,
...
import { Skeleton } from "@struxa/ui/components/skeleton";
import { Tooltip, TooltipPopup, TooltipTrigger } from "@struxa/ui/components/tooltip";
...
export function SidebarContent({
  ...
  return (
    <ScrollArea
      className="**:data-[slot=scroll-area-scrollbar]:hidden **:data-[slot=scroll-area-viewport]:overflow-x-hidden"
      scrollFade
    >
      <div
        className={cn(
